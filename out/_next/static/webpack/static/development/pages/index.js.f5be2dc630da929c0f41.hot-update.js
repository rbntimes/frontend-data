...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawLines(scoreData) {
      console.log(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_26"));
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("line").data(scoreData).enter().append("line") // .attr(
      //   "x1",
      //   ({ id }) =>
      //     projection([
...
//# sourceMappingURL=index.js.f5be2dc630da929c0f41.hot-update.js.map