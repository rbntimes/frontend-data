...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function getPlaceCoordinates(selection) {
    ...
    value: function drawLines(scoreData) {
      ...
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("line").data(scoreData).enter().append("line").attr("x1", function (_ref) {
        ...
        if (!select.empty()) {
          return projection([_this2.getPlaceCoordinates(id)[0], _this2.getPlaceCoordinates(id)[1]])[0];
        }
        ...
        if (!select.empty()) {
          return projection([_this2.getPlaceCoordinates(id)[0], _this2.getPlaceCoordinates(id)[1]])[1];
        }
...
//# sourceMappingURL=index.js.3bccf0b12704c7e2d972.hot-update.js.map