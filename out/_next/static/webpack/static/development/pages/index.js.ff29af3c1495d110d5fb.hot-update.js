  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawLines(scoreData) {
      ...
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("line").data(scoreData).enter().append("line").attr("x1", function (_ref) {
        ...
        return 0; // projection([
        //   Number(d3.select(`#id_${id}`).attr("cx")),
        //   Number(d3.select(`#id_${id}`).attr("cy"))
        // ])[0]
      }) // .attr(
      //   "y1",
      //   projection([
    ...
    value: function drawMarker(marker) {
      return d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref2) {
        var id = _ref2.id;
        return console.log(id) || (!id ? "randomplace" : "id_".concat(id));
      }).attr("cx", function (_ref3) {
        var id = _ref3.id,
            _long = _ref3["long"],
            lat = _ref3.lat;
      ...
      }).attr("r", 2).attr("fill", function (_ref5) {
        var id = _ref5.id;
...
//# sourceMappingURL=index.js.ff29af3c1495d110d5fb.hot-update.js.map