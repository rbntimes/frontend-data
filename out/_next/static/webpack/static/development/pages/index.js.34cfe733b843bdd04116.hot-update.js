...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawMarker(marker, id) {
      console.log(marker);
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", id).attr("cx", function (d) {
...
//# sourceMappingURL=index.js.34cfe733b843bdd04116.hot-update.js.map