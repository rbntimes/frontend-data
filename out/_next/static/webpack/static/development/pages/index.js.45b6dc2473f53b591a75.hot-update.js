...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
    ...
    value: function drawMarker(marker) {
      ...
      d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#markers").enter().append("circle").attr("id", "TEST");
      d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref) {
        var id = _ref.id;
        return !id ? "randomplace" : id;
...
//# sourceMappingURL=index.js.45b6dc2473f53b591a75.hot-update.js.map