...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (nextProps.comparingScores) {
        console.log(nextProps.comparingScores);
      } else if (nextProps.data.distance === null && nextProps.data.submitted) {
        this.resetMap();
...
//# sourceMappingURL=index.js.d669db844682f663fd5d.hot-update.js.map