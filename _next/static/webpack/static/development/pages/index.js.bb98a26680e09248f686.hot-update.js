  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawLines(scoreData) {
      ...
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("line").data(scoreData).enter().append("line").attr("x1", function (_ref) {
        ...
        if (!select.empty()) {
          return projection([Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cx")), Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cy"))])[0];
        }
        ...
        if (!select.empty()) {
          return projection([Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cy")), Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cx"))])[1];
        }

        return 0;
      }).attr("x2", projection([Number(randomPlaceCoordinations[0]), Number(randomPlaceCoordinations[1])])[0]).attr("y2", projection([Number(randomPlaceCoordinations[0]), Number(randomPlaceCoordinations[1])])[1]).attr("id", function (_ref3) {
        var id = _ref3.id;
    ...
    value: function drawMarker(marker) {
      return d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref4) {
        var id = _ref4.id;
        return console.log(id) || (!id ? "randomplace" : "id_".concat(id));
      }).attr("cx", function (_ref5) {
        var id = _ref5.id,
            _long = _ref5["long"],
            lat = _ref5.lat;
        return projection([Number(id ? _long : _long.value), Number(id ? lat : lat.value)])[0];
      }).attr("cy", function (_ref6) {
        var id = _ref6.id,
            _long2 = _ref6["long"],
            lat = _ref6.lat;
        return projection([Number(id ? _long2 : _long2.value), Number(id ? lat : lat.value)])[1];
      }).attr("r", 2).attr("fill", function (_ref7) {
        var id = _ref7.id;
...
//# sourceMappingURL=index.js.bb98a26680e09248f686.hot-update.js.map