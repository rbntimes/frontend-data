...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
    ...
    value: function componentDidMount() {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_10___default()("".concat( false ? undefined : "/", "static/custom.geo.json")).then(function (response) {
        ...
        response.json().then(function (worlddata) {
          ...
          _this.drawMarker(scoreData, "scoredata");
    ...
    value: function drawMarker(marker, id) {
      console.log(1);
      d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", id).attr("cx", function (d) {
        return projection([Number(d.lat), Number(d["long"])])[0];
      }).attr("cy", function (d) {
        return projection([Number(d.lat), Number(d["long"])])[1];
...
//# sourceMappingURL=index.js.39a019c4828fc931e433.hot-update.js.map