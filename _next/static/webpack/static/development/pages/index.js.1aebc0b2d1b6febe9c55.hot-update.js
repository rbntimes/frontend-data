...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawMarker(marker) {
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", !marker.id ? "randomplace" : "").attr("cx", function (_ref) {
        var id = _ref.id,
            _long = _ref["long"],
            lat = _ref.lat;
...
//# sourceMappingURL=index.js.1aebc0b2d1b6febe9c55.hot-update.js.map