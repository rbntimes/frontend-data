...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawLines(scoreData) {
      ...
      console.log(scoreData.filter(function (_ref) {
        var id = _ref.id;
        return !d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).empty();
      }));
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#lines").selectAll("line").data(scoreData).enter().append("line").attr("x1", function (_ref2) {
        var id = _ref2.id;
    ...
    value: function drawMarker(marker) {
      return d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref5) {
        var id = _ref5.id;
        return !id ? "randomplace" : "id_".concat(id);
      }).attr("cx", function (_ref6) {
        var id = _ref6.id,
            _long = _ref6["long"],
            lat = _ref6.lat;
        return projection([Number(id ? _long : _long.value), Number(id ? lat : lat.value)])[0];
      }).attr("cy", function (_ref7) {
        var id = _ref7.id,
            _long2 = _ref7["long"],
            lat = _ref7.lat;
        return projection([Number(id ? _long2 : _long2.value), Number(id ? lat : lat.value)])[1];
      }).attr("r", 2).attr("fill", function (_ref8) {
        var id = _ref8.id;
...
//# sourceMappingURL=index.js.344e2db0cd8150a5cf34.hot-update.js.map