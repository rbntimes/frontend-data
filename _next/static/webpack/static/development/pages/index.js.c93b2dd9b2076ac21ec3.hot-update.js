...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function componentDidMount() {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_11___default()("".concat( false ? undefined : "/", "static/custom.geo.json")).then(function (response) {
        ...
        response.json().then(function (worlddata) {
          ...
          map.append("g").attr("id", "markers"); // this.drawMarker(marker, "randomplace");

          _this.drawMarker([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(scoreData), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(marker)), "scoredata");
    ...
    key: "drawMarker",
    value: function drawMarker(marker, id) {
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", id).attr("cx", function (_ref) {
        var id = _ref.id,
            _long = _ref["long"],
            lat = _ref.lat;
        return iprojection([Number(id ? _long : _long.value), Number(id ? lat : lat.value)])[0];
      }).attr("cy", function (d) {
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (nextProps.data.distance === null && nextProps.data.submitted) {
        ...
        return d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#map").on("click", null);
        return false;
      }
...
//# sourceMappingURL=index.js.c93b2dd9b2076ac21ec3.hot-update.js.map