...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
    ...
    value: function handleClick() {
      ...
      this.drawMarker(this.props.marker); // Use clientPoint to check where user clicked and invert it againt projection
    ...
    value: function drawMarker(marker) {
      ...
      console.log(d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#markers"));
      return d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref) {
        var id = _ref.id;
        return console.log(id) || (!id ? "randomplace" : id);
      }).attr("cx", function (_ref2) {
        var id = _ref2.id,
            _long = _ref2["long"],
            lat = _ref2.lat;
      ...
      }).attr("r", 2).attr("fill", function (_ref4) {
        var id = _ref4.id;
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (nextProps.data.distance === null && nextProps.data.submitted) {
        ...
        d3__WEBPACK_IMPORTED_MODULE_8__["selectAll"]("circle").attr("opacity", 1);
        return false;
      } else if (nextProps.data.finished) {
        d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#randomplace").attr("opacity", 1);
        d3__WEBPACK_IMPORTED_MODULE_8__["select"]("#map").on("click", null);
        return false;
      }
...
//# sourceMappingURL=index.js.966986c490d18148d60e.hot-update.js.map