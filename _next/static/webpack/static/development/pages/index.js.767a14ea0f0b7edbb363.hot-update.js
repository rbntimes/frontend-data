  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function drawLines(scoreData) {
      ...
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("line").data(scoreData).enter().append("line").attr("x1", function (_ref) {
        var id = _ref.id;
        return id ? projection([Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cx") || 0), Number(d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#id_".concat(id)).attr("cy") || 0)])[0] : 0;
      }) // .attr(
      //   "y1",
      //   projection([
...
//# sourceMappingURL=index.js.767a14ea0f0b7edbb363.hot-update.js.map