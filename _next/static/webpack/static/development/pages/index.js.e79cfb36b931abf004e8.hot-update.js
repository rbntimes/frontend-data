...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Map, [{
    ...
    value: function componentDidMount() {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_11___default()("".concat( false ? undefined : "/", "static/custom.geo.json")).then(function (response) {
        ...
        response.json().then(function (worlddata) {
          ...
          _this.drawMarker([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(scoreData), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(marker)));
    ...
    value: function drawMarker(marker) {
      d3__WEBPACK_IMPORTED_MODULE_9__["select"]("#markers").selectAll("circle").data(marker).enter().append("circle").attr("id", function (_ref) {
        var id = _ref.id;
        return !id ? "randomplace" : "";
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (nextProps.data.distance === null && nextProps.data.submitted) {
        ...
        return false;
      } else if (nextProps.data.comparingScores) {
        d3__WEBPACK_IMPORTED_MODULE_9__["select"]();
        return false;
      }
...
//# sourceMappingURL=index.js.e79cfb36b931abf004e8.hot-update.js.map